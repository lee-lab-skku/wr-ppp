...
- **Progress** explains meaningful changes in results, implementation, or understanding and the evidence that supports them.
- **Problems** explains uncertainty, obstacles, failed or incomplete responses, constraints, or decisions that need input.
- **Plans** prioritizes next actions and makes expected outputs, success criteria, dependencies, or fallbacks concrete when useful.
...
- preserve the author's language, voice, degree of certainty, and stated priorities unless asked to change them;
...
Judge the report against its intended audience and purpose rather than a universal prose style. A useful review may address factual traceability, PPP balance, decision usefulness, readability, visual evidence, or concision in any combination. The two-page target is guidance, not a reason to remove necessary context or compress text until it becomes obscure.
